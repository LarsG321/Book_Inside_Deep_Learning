# this module contains different functions from the Inside Deep Learning Book by Edward Staff
# please see the github: https://github.com/EdwardRaff/Inside-Deep-Learning/blob/main/idlmam.py
import torch
